...
<head>
    ...
    <link href="/css/parallax-sliderv0.css" rel="stylesheet">   
	          		...
	          		<div class="nav-collapse collapse">
	            		<ul id="menuSuperior" class="nav" style="margin-right:-30px;">
							...
							<li id="menuSobre"><a onClick="ga('send', 'event', 'Menu Superior', 'Menu Sobre', 'Sobre');" title="Sobre" href="/sobre">Sobre nosotros</a></li>
	              			...
	              			<li id="menuMas" style="margin-top: -8px;"><a title="Más" onClick="ga('send', 'event', 'Menu Superior', 'Menu RSS', 'RSS');" href="#newsletter"><img src="/img/logo_follow.png" alt="Más"></a></li>
	            		</ul>
	          		</div>
	        	</div>
	      	</div>
