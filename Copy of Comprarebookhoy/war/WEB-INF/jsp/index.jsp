	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<c:forEach var="publicacion" items="${publicacionesPortada}" varStatus="status" end="4">
				<div class="da-slide">
					<h2 class="titPortada"><a title="${publicacion.titulo}" href="<c:out value="${publicacion.tipo eq 'EB' ? '/ebooks/' : '/blog/'}" />${publicacion.url}" onClick="ga('send', 'event', 'Leer', 'Home ${publicacion.url}', 'Titulo Portada');">${publicacion.tituloPortada}</a></h2>
